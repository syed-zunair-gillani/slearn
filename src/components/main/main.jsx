        ...
        <div className='container mx-auto px-4 py-28 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
          {
            data.map((uni,idx)=>{
              return(
                <Link href={uni.slug?.current} key={idx} className="flex justify-center border border-gray-100 items-center flex-col shadow-md rounded-lg py-20 hover:shadow-lg">
